...
(function($) {
    $.fn.formToWizard = function( options, cmdParam1 ) {
        ...
        function createPrevButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<input type='button' id='" + stepName + "Prev' style='float:left; margin:0px 18px;' class='prev button blueB' value='" + options.prevBtnName + "'/>");
        ...
        function createNextButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<input type='button' id='" + stepName + "Next' style='float:right; margin:0px 18px;' class='next button greenB' value='" + options.nextBtnName + "'/>");
