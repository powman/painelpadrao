    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "ajaxUserCall": {
                    "url": "index.php?acao=verificaUsuario&ctrl=usuarios",
                ...
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxUserCallAlt": {
                    "url": "index.php?acao=verificaUsuarioAlt&ctrl=usuarios",
                    // you may want to pass extra data on the ajax call
                    "alertText": "* Este usuário já existe",
                    "alertTextOk":"* Ok",
                    "alertTextLoad": "* Validando, por favor aguarde"
                ...
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxUserCallEmail": {
                    "url": "index.php?acao=verificaUsuarioEmail&ctrl=usuarios",
                    // you may want to pass extra data on the ajax call
                    "alertText": "* Este email já existe",
                    "alertTextOk":"* Ok",
                    "alertTextLoad": "* Validando, por favor aguarde"
                ...
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxUserCallSenha": {
                    "url": "index.php?acao=verificaUsuarioSenha&ctrl=usuarios",
                    // you may want to pass extra data on the ajax call
