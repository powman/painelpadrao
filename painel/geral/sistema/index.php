...
?>
    ...
    <body>
        ...
        <!-- Left side content -->
        <div id="leftSide">
            <div class="logo"><a href="<?php echo $configuracao["siteDesenvolvedor"] ?>" target="_blank"><img src="<?php echo $configuracao['urllogo']; ?>" alt="" width='82' /></a></div>

            <div class="sidebarSep mt0"></div>

            <!-- Sidebar profile -->
            <div class="sideProfile">
                <a href="../gt.php?img=sistema/<?php echo $objSession2->get('tlAdmLoginImg') ?>&h=250" title="<?php echo $objSession2->get('tlAdmLoginNome') ?>" rel="lightbox" class="profileFace"><img src="../gt.php?img=sistema/<?php echo $objSession2->get('tlAdmLoginImg') ?>&h=36" alt="" /></a>
                <span>Olá <strong><?php echo $objSession2->get('tlAdmLoginNome') ?></strong></span>
                <div class="clear"></div>
                <div class="sidedd">
                    ...
                    <ul class="sideDropdown">
                        ...
                        ?>
                            ...
                            <?php if ($configuracao["whm"]['dominio'] && $configuracao["whm"]['user'] && $configuracao["whm"]['pass'] && $configuracao["whm"]['userCpanelCliente']) : ?>
            ...
            <ul id="menu" class="nav">
                ...
                ?>
                    <?php if (count($menus) &&  isset($permissao2->id) &&  $permissao2->id) : ?>
                        <li><a href="#" title="" class="exp"><span style="background-image:url('<?php echo $secoes_fixas[$i]->img ?>')"><?php echo $secoes_fixas[$i]->menu ?></span></a>
                            <ul class="sub">
                                <?php for ($j = 0; $j < $menus["num"]; $j++) { ?>
                                    <li><a href="<?php echo $menus[$j]->url ?>" title=""><?php echo $menus[$j]->titulo ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    <?php endif; ?>
        ...
        <div id="rightSide">
            ...
            <div class="topNav">
                <div class="wrapper">
                    <div class="welcome"><a href="../gt.php?img=sistema/<?php echo $objSession2->get('tlAdmLoginImg') ?>&h=250" title="<?php echo $objSession2->get('tlAdmLoginNome') ?>" rel="lightbox"><img src="../gt.php?img=sistema/<?php echo $objSession2->get('tlAdmLoginImg') ?>&h=16" alt="" /></a><span>Bem vindo, <?php echo $objSession2->get('tlAdmLoginNome') ?>!</span></div>
                    <div class="userNav">
                        <ul>
                            <?php if (isset($permissao->cadastrar) && $permissao->cadastrar == "1") { ?>
                ...
                <div class="smalldd">
                    ...
                    <ul class="smallDropdown">
                        ...
                        ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php for ($i = 0; $i < $secoes_fixas["num"]; $i++) {
                            $sem_acento = $objUteis->nameArq(utf8_decode($secoes_fixas[$i]->titulo));
                            $permissao2 = $objSecao->permissaoSecaoFixaUsuario($secoes_fixas[$i]->id, $objSession2->get('tlAdmLoginId'));
                            $menus = $objSecao->listar_menu_by_secao_fixa($secoes_fixas[$i]->id);
                            $objUteis->encode($menus);
                        ?>
                            <?php if (count($menus) &&  isset($permissao2->id) &&  $permissao2->id) { ?>
                                <li><a href="<?php echo $menus[$j]->url ?>" title="" class="exp"><img src="<?php echo $secoes_fixas[$i]->img ?>" alt="" /><?php echo $secoes_fixas[$i]->menu ?></a>
                                    <ul class="sub">
                                        <?php for ($j = 0; $j < $menus["num"]; $j++) { ?>
                                            <li><a href="<?php echo $menus[$j]->url ?>" title=""><?php echo $menus[$j]->titulo ?></a></li>
                                        <?php } ?>
            ...
            <!-- Footer line -->
            <div id="footer">
                <div class="wrapper">Todos direitos reservados a <a href="<?php echo $configuracao["siteDesenvolvedor"] ?>" target="_blank" title=""><?php echo $configuracao["siteDesenvolvedor"] ?></a></div>
            </div>
