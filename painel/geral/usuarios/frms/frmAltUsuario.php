        ...
        <div>
                <div class="widget">
                    <div class="title"><img src="images/icons/dark/alert.png" alt="" class="titleIcon" /><h6>Usuário</h6></div>
                    <fieldset class="step">
                    <h1>Dados do usuário</h1>
                    <div class="formRow">
                        <label>Nome:<span class="req">*</span></label>
                        <div class="formRight">
                            <input type="text" class="validate[required] tipS" title="Nome do usuário do sistema." name="nome" id="nome" title="Nome" value="<?=$usuario->nome;?>"/>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" class="validate[required] tipS" name="email" id="email" title="Seu email, deve ser uma email válido." value="<?=$usuario->email;?>"/>
                        </div>
                        <div class="clear"></div>
                    </div>
                    </fieldset>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <img src="../sistema/<?=$usuario->img;?>" width="100" />
                        </div>
                        <div class="clear"></div>
                    </div>
                     <?
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <select name="nivel" id="nivel" class="tipS" title="Administrator tem acesso as configurações do sistema, o nível usuário não tem acesso as configurações do sistema.">
                                <option value="1" <? if($usuario->nivel=="1") echo "selected"; ?>>Administrador</option>
                                <option value="0" <? if($usuario->nivel=="0") echo "selected"; ?>>Usuário</option>
                            </select>
                        </div>
                        <div class="clear"></div>
                    </div>
        ...
        <div>
            ...
            <!-- Media table -->
            <div class="widget">
                <div class="title"><h6>Permissão do usuário</h6></div>
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <tbody class="prachegar">
                        ...
                        ?>
                        <tr class="secoesParaChecar<?=$i?>">
                            <td><input name="secao_fixa[]" id="todosFixa<?=$i?>" type="checkbox" onclick="selecionarTodosItensUsuario('<?=$i?>')" value="<?=$secoes_fixas[$i]->id;?>" <?=$checkedf[$i]['cadastrar'];?>/></td>
                            <td align="center"><?=$secoes_fixas[$i]->menu?></td>
                            <td><input type="checkbox" class="cadastrarFixa<?=$i?>" name="cadastrar_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1" <?=$checkedf[$i]['cadastrar'];?>/></td>
                            <td><input type="checkbox" class="alterarFixa<?=$i?>" name="alterar_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1" <?=$checkedf[$i]['alterar'];?>/></td>
                            <td><input type="checkbox" class="excluirFixa<?=$i?>" name="excluir_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1"  <?=$checkedf[$i]['excluir'];?>/></td>
                            <td><input type="checkbox" class="publicarFixa<?=$i?>" name="publicar_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1" <?=$checkedf[$i]['publicar'];?>/></td>
                        </tr>
                        <?
                          }
                        }
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <input type="hidden" name="imgAntiga" id="imgAntiga" value="<?=$usuario->img;?>" />
