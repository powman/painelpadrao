                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <tbody class="prachegar">
                        ...
                        <tr class="secoesParaChecar<?=$i?>">
                            <td><input name="secao_fixa[]" id="todosFixa<?=$i?>" type="checkbox" onclick="selecionarTodosItensUsuario('<?=$i?>')" value="<?=$secoes_fixas[$i]->id;?>" /></td>
                            <td align="center"><?=$secoes_fixas[$i]->menu?></td>
                            <td><input type="checkbox" class="cadastrarFixa<?=$i?>" name="cadastrar_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1" /></td>
                            <td><input type="checkbox" class="alterarFixa<?=$i?>" name="alterar_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1" /></td>
                            <td><input type="checkbox" class="excluirFixa<?=$i?>" name="excluir_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1"  /></td>
                            <td><input type="checkbox" class="publicarFixa<?=$i?>" name="publicar_fixa[<?=$secoes_fixas[$i]->id;?>]" value="1" /></td>
                        </tr>
                        <?
                          }
                        }
