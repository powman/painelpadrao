...
class Config
{
	...
	public static function AtributosConfig()
	{
		...
		$allConfig["banco"]["local"]["senha"] = "jesus";
		$allConfig["banco"]["local"]["banco"] = "painelpadrao";
		$allConfig["banco"]["local"]["port"] = "3306";
		$allConfig["banco"]["local"]["type"] = "mysql";

		## INI - site do desenvolvedor ##
		$allConfig["siteDesenvolvedor"] = "http://www.pauloph.com.br/";

		## INI - Nome do cliente ##
		$allConfig["nomeCliente"] = "Pauloph";

		## INI - Site do cliente ##
		$allConfig["siteCliente"] = "http://www.pauloph.com.br/";
